...
(
    ...
    `logradouro_emitente`      varchar(200),
    `numero_emitente`          varchar(200),
    `bairro_emitente`          varchar(120),
    `cidade_emitente`          varchar(120),
    ...
    `logradouro_destinatario`  varchar(200),
    `numero_destinatario`      varchar(200),
    `bairro_destinatario`      varchar(120),
    `cidade_destinatario`      varchar(120),
