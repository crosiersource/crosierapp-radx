...
DROP TABLE IF EXISTS `est_fornecedor_contato`;
CREATE TABLE `est_fornecedor_contato`
(
    ...
    KEY `K_est_fornecedor_contato_fornecedor` (`fornecedor_id`),
    CONSTRAINT `FK_est_fornecedor_contato_fornecedor` FOREIGN KEY (`fornecedor_id`) REFERENCES `est_fornecedor` (`id`),
    ...
    `user_inserted_id`   bigint(20)                NOT NULL,
    `user_updated_id`    bigint(20)                NOT NULL,
    KEY `K_est_fornecedor_contato_estabelecimento` (`estabelecimento_id`),
    KEY `K_est_fornecedor_contato_user_inserted` (`user_inserted_id`),
    KEY `K_est_fornecedor_contato_user_updated` (`user_updated_id`),
    CONSTRAINT `FK_est_fornecedor_contato_user_inserted` FOREIGN KEY (`user_inserted_id`) REFERENCES `sec_user` (`id`),
    CONSTRAINT `FK_est_fornecedor_contato_estabelecimento` FOREIGN KEY (`estabelecimento_id`) REFERENCES `cfg_estabelecimento` (`id`),
    CONSTRAINT `FK_est_fornecedor_contato_user_updated` FOREIGN KEY (`user_updated_id`) REFERENCES `sec_user` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_swedish_ci;


DROP TABLE IF EXISTS `est_fornecedor_endereco`;
CREATE TABLE `est_fornecedor_endereco`
(
    `id`                 bigint(20) AUTO_INCREMENT NOT NULL,
    `fornecedor_id`      bigint(20)                NOT NULL,
    ...
    KEY `K_est_fornecedor_endereco_fornecedor` (`fornecedor_id`),
    CONSTRAINT `FK_est_fornecedor_endereco_fornecedor` FOREIGN KEY (`fornecedor_id`) REFERENCES `est_fornecedor` (`id`),
    ...
    `user_inserted_id`   bigint(20)                NOT NULL,
    `user_updated_id`    bigint(20)                NOT NULL,
    KEY `K_est_fornecedor_endereco_estabelecimento` (`estabelecimento_id`),
    KEY `K_est_fornecedor_endereco_user_inserted` (`user_inserted_id`),
    KEY `K_est_fornecedor_endereco_user_updated` (`user_updated_id`),
    CONSTRAINT `FK_est_fornecedor_endereco_user_inserted` FOREIGN KEY (`user_inserted_id`) REFERENCES `sec_user` (`id`),
    CONSTRAINT `FK_est_fornecedor_endereco_estabelecimento` FOREIGN KEY (`estabelecimento_id`) REFERENCES `cfg_estabelecimento` (`id`),
    CONSTRAINT `FK_est_fornecedor_endereco_user_updated` FOREIGN KEY (`user_updated_id`) REFERENCES `sec_user` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_swedish_ci;
...
(
    ...
    UNIQUE KEY `est_unidade_produto` (`label`),
    ...
    `user_inserted_id`   bigint(20)   NOT NULL,
    `user_updated_id`    bigint(20)   NOT NULL,
    KEY `K_est_unidade_produto_estabelecimento` (`estabelecimento_id`),
    KEY `K_est_unidade_produto_user_inserted` (`user_inserted_id`),
    KEY `K_est_unidade_produto_user_updated` (`user_updated_id`),
    CONSTRAINT `FK_est_unidade_produto_user_inserted` FOREIGN KEY (`user_inserted_id`) REFERENCES `sec_user` (`id`),
    CONSTRAINT `FK_est_unidade_produto_estabelecimento` FOREIGN KEY (`estabelecimento_id`) REFERENCES `cfg_estabelecimento` (`id`),
    CONSTRAINT `FK_est_unidade_produto_user_updated` FOREIGN KEY (`user_updated_id`) REFERENCES `sec_user` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_swedish_ci;
