...
VALUES (1, 1, 'ENTRADAS', NULL, 0, 1, NULL, 0, NULL, NULL, 100000000000, now(), now(), 0, 1, 1, 1),
 ...
 (179, 179, 'REAPRESENTAÇÃO DE CHEQUE (ENTRANDO)', 1, 0, 1, '', 0, '', '', 179000000000, now(), now(), 0, 1, 1, 1),
 (180, 180, 'ENTRADAS PESSOAIS', 1, 0, 1, '', 0, '', null, 180000000000, now(), now(), 2, 1, 1, 1),
 (188, 188, 'MOVIMENTAÇÃO ESTORNADA (ENTRANDO)', 1, 0, 1, '%s', 0, NULL, NULL, 188000000000, now(), now(), 0, 1, 1, 1),
 ...
 (270, 270, 'MOVIMENTAÇÃO ESTORNADA (SAINDO)', 2, 0, 2, NULL, 0, NULL, NULL, 270000000000, now(), now(), 0, 1, 1, 1),
 (279, 279, 'REAPRESENTAÇÃO DE CHEQUE (SAINDO)', 2, 0, 2, NULL, 0, NULL, NULL, 279000000000, now(), now(), 0, 1, 1, 1),
