...
VALUES ('189dd86e-f806-4f96-8d5e-2a3e388c6976', 'Financeiro', 'fas fa-dollar-sign', 'ENT', '2c16979f-2663-496e-9287-566fcb63629a', '/', '',
...
VALUES ('b7a5f134-ea80-40e4-822e-e04cdac70258', 'crosierapp-finan (Menu Raíz)', '', 'PAI',
        '2c16979f-2663-496e-9287-566fcb63629a', '', '', null, 0, null, now(), now(), 1, 1, 1);
...
VALUES ('3984a4f5-cd55-4525-87b9-01212fb1952c', 'Lançamento', 'fas fa-sign-out-alt', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/movimentacao/form/ini/', '', 'b7a5f134-ea80-40e4-822e-e04cdac70258',
...
VALUES ('e8d385b5-5fe2-41f0-b8e2-f1d1ad7bd097', 'A Pagar/Receber', 'fas fa-file-invoice-dollar', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/aPagarReceber/list/', '', 'b7a5f134-ea80-40e4-822e-e04cdac70258', 2,
        null, now(), now(), 1, 1, 1);
...
VALUES ('61d20df0-d26b-4e29-a304-9c56121d7fd0', 'Pesquisar', 'fas fa-search-dollar', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/movimentacao/list/', '', 'b7a5f134-ea80-40e4-822e-e04cdac70258', 3,
        null, now(), now(), 1, 1, 1);
...
VALUES ('0bc57722-bd1c-44fe-911e-2657d49c2965', 'Extrato', 'fas fa-list-ol', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/movimentacao/extrato', '', 'b7a5f134-ea80-40e4-822e-e04cdac70258', 4,
        null, now(), now(), 1, 1, 1);
...
VALUES ('fdabfbb2-197f-4cd4-87dd-f3ea02ef7a06', 'Importação', 'fas fa-file-import', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/movimentacao/import', '', 'b7a5f134-ea80-40e4-822e-e04cdac70258', 5,
        null, now(), now(), 1, 1, 1);
...
VALUES ('79c10300-39f8-4192-ac45-af4113d97ea7', 'Caixas', 'fas fa-hand-holding-usd', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/movimentacao/caixa', '', 'b7a5f134-ea80-40e4-822e-e04cdac70258', 6,
        null, now(), now(), 1, 1, 1);
...
VALUES ('31b009a5-758b-4ee4-b47c-f42df678868d', 'Recorrentes', 'fas fa-undo', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/movimentacaoRecorrente/list/', '',
...
VALUES ('d75b1eb9-3f15-4eb9-a87d-d1ebb33172ff', 'Agrupadas', 'fas fa-layer-group', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/grupoItem/listMovs/', '', 'b7a5f134-ea80-40e4-822e-e04cdac70258', 8,
        null, now(), now(), 1, 1, 1);
...
VALUES ('a2f6c378-71c8-426b-8974-804187e8776a', 'Cadastros', 'fas fa-clipboard-list', 'DROPDOWN',
        '2c16979f-2663-496e-9287-566fcb63629a', '', '', 'b7a5f134-ea80-40e4-822e-e04cdac70258', 99,
...
VALUES ('8b1a74a8-fb70-4a05-a1e1-150e2561ce70', 'Carteiras', 'fas fa-piggy-bank', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/carteira/list/', '', 'a2f6c378-71c8-426b-8974-804187e8776a', 1, null,
        now(), now(), 1, 1, 1);
...
VALUES ('b41a78d8-14ec-4ba4-8ec6-453240719321', 'Categorias', 'fas fa-stream', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/categoria/list/', '', 'a2f6c378-71c8-426b-8974-804187e8776a', 2, null,
        now(), now(), 1, 1, 1);
...
VALUES ('6f68649c-516c-4b1f-a735-040d9f7125a9', 'Centros de Custos', 'fas fa-location-arrow', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/centroCusto/list/', '', 'a2f6c378-71c8-426b-8974-804187e8776a', 3,
        null, now(), now(), 1, 1, 1);
...
VALUES ('db8eea41-44c2-49dc-b850-fb0b0a8631bd', 'Grupos', 'fas fa-sitemap', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/grupo/list/', '', 'a2f6c378-71c8-426b-8974-804187e8776a', 4, null,
        now(), now(), 1, 1, 1);
...
VALUES ('b1dcae54-08ce-4b25-b38b-a8f7d56218e8', 'Modos', 'fas fa-sitemap', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/modo/list/', '', 'a2f6c378-71c8-426b-8974-804187e8776a', 5, null,
        now(), now(), 1, 1, 1);
...
VALUES ('5fe09111-9fce-4eaf-b65a-060a09d2f8e7', 'Operadoras de Cartão', 'fas fa-building', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/operadoraCartao/list/', '', 'a2f6c378-71c8-426b-8974-804187e8776a', 6,
        null, now(), now(), 1, 1, 1);
...
VALUES ('ced83376-84a7-4c89-a185-e252a9ae3936', 'Bandeiras de Cartão', 'fab fa-cc-visa', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/bandeiraCartao/list/', '', 'a2f6c378-71c8-426b-8974-804187e8776a', 7,
        null, now(), now(), 1, 1, 1);
...
VALUES ('cb7e4d97-59fe-4666-880f-6f8eecd806f3', 'Regras de Importação', 'fas fa-file-excel', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/regraImportacaoLinha/list/', '',
...
VALUES ('e2ffd6b9-81d6-4ff1-84ab-ada9670484ce', 'Registros para Conferências', 'fas fa-check-circle', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/registroConferencia/list/', '',
...
VALUES ('5cf74ef9-4d4d-4283-98d0-120d4617a7ea', 'Bancos', 'fas fa-university', 'ENT',
        '2c16979f-2663-496e-9287-566fcb63629a', '/banco/list/', '', 'a2f6c378-71c8-426b-8974-804187e8776a', 10, null,
        now(), now(), 1, 1, 1);
